...
<%@ include file="ProName.jsp" %>
 ...
 try {
	 ...
	 out.println("<h2 style='color:white; margin-left:500px'>Results for Searching Neosporin Product Name</h2>");
	 ...
	 while(res.next()){
		 ...
		 String neoStore = "SELECT St.name, St.street, St.city, St.zip_code,St.phone_number FROM Store St  WHERE St.SID IN(SELECT SB.SID FROM SoldByStore SB WHERE SB.DID = '"+ id +"')  ";
		 PreparedStatement ps1 = con.prepareStatement(neoStore);
