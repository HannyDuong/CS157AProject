...
<title>Category Foot Care</title>
</head>
<body>
<%@ include file="Category.jsp" %>
 ...
 try 
 {
	 ...
	 String CategoryFootCare = "SELECT D.DID, D.GenericName, D.BrandName, D.Form, D.Description, D.Notes FROM Drug D WHERE D.Category = 'FootCare'";
	 PreparedStatement ps = con.prepareStatement(CategoryFootCare);
	 ResultSet res = ps.executeQuery();
	 
	 out.println("<div style=margin-top:100px>");
	 out.println("<h2 style='color:white; margin-left:400px'>Results for Searching Foot Care Category</h2>");
	 ...
	 while(res.next())
	 {
		 ...
		 String StoreE = "SELECT St.name, St.street, St.city, St.zip_code, St.phone_number FROM Store St WHERE St.SID IN(SELECT SB.SID FROM SoldByStore SB WHERE SB.DID = '"+ col1 +"')";
		 PreparedStatement ps1 = con.prepareStatement(StoreE);
